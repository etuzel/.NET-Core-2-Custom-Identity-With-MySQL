...
{
    public class CustomIdentityProvider : IUserStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>, IUserEmailStore<ApplicationUser>
    {
        private readonly UsersRepo _users;

        public CustomIdentityProvider(UsersRepo users)
        {
            _users = users;
        }
        ...
        public Task<IdentityResult> CreateAsync(ApplicationUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Task.FromResult(_users.Create(user));
        }
        ...
        {
            return Task.FromResult(_users.FindByMail(normalizedEmail));
        }
        ...
        public Task<ApplicationUser> FindByNameAsync(string userName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Task.FromResult(_users.FindByMail(userName));
        }
    ...
    public class CustomRoleProvider : IRoleStore<ApplicationRole>
    {
